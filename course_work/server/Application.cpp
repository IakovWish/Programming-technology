...
bool Application::parseOptionsWithParam(const QString& arg, const QString& param)
{
...
bool Application::isOption( const QString& arg, const QString& option1, const QString& option2)
{
